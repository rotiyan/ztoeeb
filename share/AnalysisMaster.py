...
#jp.AthenaCommonFlags.FilesInput = glob.glob('/tmp/narayan/mc11_7TeV.107650.AlpgenJimmyZeeNp0_pt20.merge.AOD.e835_s1299_s1300_r3043_r2993*/*root*')
jp.AthenaCommonFlags.FilesInput = glob.glob('/tmp/narayan/data*/*root*')
